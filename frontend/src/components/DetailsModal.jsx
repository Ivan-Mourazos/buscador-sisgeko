                    ...
                    <div className="max-w-4xl mx-auto space-y-10">
                        ...
                        <div className="space-y-12">
                            ...
                            {item._type === 'definicion' && (
                                <div className="p-10 bg-amber-50/20 rounded-[2.5rem] border border-amber-100 ring-1 ring-amber-50 italic font-serif">
                                        ...
                                        <section>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                {details.caracteristicas.map((car, idx) => (
                                                    <div key={idx} className="bg-gray-50/50 hover:bg-white rounded-[1.5rem] p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all hover:border-yellow-100 group">
