...
export const ResultCard = ({ item, onClick }) => {
    ...
    switch (item._type) {
        case 'articulo':
            return (
                <div onClick={onClick} className="cursor-pointer bg-white p-5 rounded-2xl shadow-md border border-gray-200 hover:border-yellow-400 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl flex flex-col gap-3 group">
                    <div className="flex justify-between items-start">
                        <Badge colorClass="bg-yellow-50 text-yellow-700 border-yellow-100">Artículo</Badge>
